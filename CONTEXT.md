...
- Bootstrap templates: `plugins/immune-brain/runtime/bootstrap.ts`, `plugins/immune-brain/runtime/bootstrap-templates/` (new project scaffolding for Immune-Brain files and navigation pointers)
