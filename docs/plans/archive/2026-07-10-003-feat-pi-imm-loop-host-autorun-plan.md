...
origin:
  ...
  - docs/specs/archive/2026-07-10-pi-imm-loop-host-autorun.spec.md
---
...
- Spec: docs/specs/archive/2026-07-10-pi-imm-loop-host-autorun.spec.md
...
- Design authority: `docs/specs/archive/2026-07-10-pi-imm-loop-host-autorun.spec.md` is the single Technical Design baseline. Steps below reference its authority, follow-up, stop, recovery, and rollback invariants rather than redefining them.
