...
- Scope: `docs/plans/managed-task-routing-policy.json`; `docs/specs/archive/assurance-kernel-v4-p3-v3-creation-retirement.spec.md`; `docs/plans/2026-08-13-015-feat-assurance-kernel-p3-v3-creation-retirement-plan.md`; `docs/plans/2026-08-13-016-fix-assurance-kernel-p3-v3-creation-retirement-scope-plan.md`; `docs/specs/archive/assurance-kernel-v4-p2-managed-cutover.spec.md`; `tests/v3-retirement-live-boundary.test.ts`; `tests/legacy-v3-projection.test.ts`; `HANDOFF.md`
