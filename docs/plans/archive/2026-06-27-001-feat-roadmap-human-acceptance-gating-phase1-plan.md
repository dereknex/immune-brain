...
- **Roadmap Spec**: `docs/specs/archive/roadmap-human-acceptance-gating.spec.md` (this Spec defines the full 4-phase roadmap)
...
- contract surface: `docs/specs/archive/roadmap-human-acceptance-gating.spec.md` (this Spec), `CONTEXT.md` (canonical term registry), `docs/brainstorms/` (example Roadmap). No runtime, skill contract, template, or test surfaces are touched in Phase 1.
...
- rollback path: Revert `docs/specs/archive/roadmap-human-acceptance-gating.spec.md`, CONTEXT.md term additions, and the example Roadmap file. No other files are affected.
