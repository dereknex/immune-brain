...
- contract surface: `docs/specs/2026-07-28-roadmap-plan-boundary-successor.spec.md`, `plugins/immune-brain/runtime/state_ledger.ts`, `plugins/immune-brain/runtime/immune_brain_runtime.ts`, `plugins/immune-brain/runtime/imm_core.ts` only if export parity requires it, command manifest/help output, and focused State Ledger/runtime tests.
