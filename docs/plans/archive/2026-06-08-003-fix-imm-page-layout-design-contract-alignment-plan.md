...
- Spec: docs/specs/imm-page-layout-design-contract-alignment.spec.md
...
- contract surface: `plugins/immune-brain/skills/imm-page-layout-design/SKILL.md`, `plugins/immune-brain/dist/imm-page-layout-design.md`, `plugins/immune-brain/dist/imm-ui-review.md`, `plugins/immune-brain/skills/registry.yaml`, `plugins/immune-brain/dist/registry.yaml`, README, `docs/user_manual.md`, `docs/reference/immune-brain-skills-guide.md`, `tests/test_skill_contracts.py`, and `docs/specs/imm-page-layout-design-contract-alignment.spec.md`.
