...
- Discovery cache: skills/imm-arch-explorer/SKILL.md (Domain Mapper prompt contract); tests/test_skill_contracts.py (contract regression surface); docs/specs/archive/imm-arch-explorer-domain-mapper.spec.md (phase boundary)
