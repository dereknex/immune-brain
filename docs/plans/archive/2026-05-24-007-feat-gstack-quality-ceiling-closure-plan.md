...
- Spec: docs/specs/gstack-quality-ceiling-closure.spec.md
...
- Discovery cache: docs/reference/gstack-quality-ceiling-protocol.md (closed guidance); tests/test_skill_contracts.py (drift guard); docs/solutions/contracts.md (Learning hub); .imm/memory/MEMORY.md (memory index); HANDOFF.md (handoff surface); docs/specs/gstack-quality-ceiling-closure.spec.md (accepted behavior)
