...
- Spec: `docs/specs/assurance-kernel-v4-p2a-observation-r2.spec.md`
...
- Roadmap source: `docs/specs/assurance-kernel-v4-p2-managed-cutover.spec.md`; `docs/specs/assurance-kernel-v4-p2a-readiness-r2.spec.md`.
...
- Technical Design baseline: `docs/specs/assurance-kernel-v4-p2a-observation-r2.spec.md`.
