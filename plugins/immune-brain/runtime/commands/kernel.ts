		...
		result: jsonResult(
			{
				...
				descriptor_rehearsal: {
					...
					setup_timeout: "non_waivable_close_settled",
					cancellation: "non_waivable_close_settled",
					output_limit: "non_waivable_close_settled",
					setup_failure: "non_waivable",
					live_integrity_drift: "abort_all_non_waivable_close_settled",
					parent_fingerprint: "git_visible_content_bytes",
				},
			},
			0,
		),
